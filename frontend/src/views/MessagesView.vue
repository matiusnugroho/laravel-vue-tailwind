...
<template>
  ...
  <div class="w-full bg-white rounded-lg shadow-md p-4">
    <div class="flex flex-col items-center pb-4">
      <h5 class="text-xl font-medium mt-4">This is Message page edit</h5>
    ...
    <ul class="flex justify-center space-x-4">
      <li>
        <a href="https://www.instagram.com/" class="text-sm text-blue-500 hover:text-blue-700">
          <i class="fab fa-instagram"></i> Instagram
        </a>
      </li>
      <li>
        <a href="https://www.linkedin.com/" class="text-sm text-blue-500 hover:text-blue-700">
